...
public class ResourceExceptionHandler {
    ...
    @ExceptionHandler(com.github.adeniltonarcanjo.Bookstore.services.exceptions.DataIntegrityViolationException.class)
    ...
    public ResponseEntity<StandardError> validateError(MethodArgumentNotValidException e, ServletRequest request){
